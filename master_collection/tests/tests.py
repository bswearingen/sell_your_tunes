...
## Fully Populated
    def test_get_fully_populated_album(self):
        response = self.client.get(reverse("master_collection:album", args=[1]))
    ...
    def test_get_fully_populated_artist(self):
        response = self.client.get(reverse("master_collection:artist", args=[1]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_fully_populated_track(self):
        response = self.client.get(reverse("master_collection:track", args=[1]))
        self.assertEqual(response.status_code, 200)
...
## Minimally Populated
    def test_get_minimally_populated_album(self):
        response = self.client.get(reverse("master_collection:album", args=[2]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_minimally_populated_artist(self):
        response = self.client.get(reverse("master_collection:artist", args=[2]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_minimally_populated_track(self):
        response = self.client.get(reverse("master_collection:track", args=[2]))
        self.assertEqual(response.status_code, 200)
